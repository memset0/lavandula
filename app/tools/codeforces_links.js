...
class CodeforcesLinks extends BaseTool {
	...
	links(round, problem) {
		return [
			...
			{ text: '在 codeforces.ml 中镜像中打开', href: `https://codeforces.ml/contest/${round}/problem/${problem}` },
			{ text: '在 codeforc.es 中镜像中打开', href: `https://codeforc.es/contest/${round}/problem/${problem}` },
