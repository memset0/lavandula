...
lavandula.Select = (function () {
  ...
  function Select(selector, opts) {
    ...
    var oldInst = $selectNative.data('lavandula.select');
    if (oldInst) {
      return oldInst;
    }
  ...
  Select.prototype.handleUpdate = function () {
    ...
    $selectNative.find('option').each(function (index, option) {
      ...
      _this.$items = _this.$items.add(
        $('<div class="lavandula-select-menu-item lavandula-ripple"' +
    ...
    // selected
    _this.$selected = $('<span class="lavandula-select-selected">' + _this.text + '</span>');

    // select
    _this.$select =
      $(
        '<div class="lavandula-select lavandula-select-position-' + _this.options.position + '" ' +
    ...
    // menu
    _this.$menu =
      $('<div class="lavandula-select-menu"></div>')
    ...
    _this.$select.on('click', function (e) {
      ...
      // 在菜单上点击时不打开
      if ($target.is('.lavandula-select-menu') || $target.is('.lavandula-select-menu-item')) {
        return;
      }
  ...
  var transitionEnd = function (inst) {
    inst.$select.removeClass('lavandula-select-closing');
  ...
  Select.prototype.open = function () {
    ...
    _this.$select.addClass('lavandula-select-open');
  ...
  Select.prototype.close = function () {
    ...
    _this.$select
      .removeClass('lavandula-select-open')
      .addClass('lavandula-select-closing');
    _this.$menu.transitionEnd(function () {
      transitionEnd(_this);
    });
  };
