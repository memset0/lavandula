...
lavandula.Tooltip = (function () {
  ...
  function Tooltip(selector, opts) {
    ...
    var oldInst = _this.$target.data('lavandula.tooltip');
    if (oldInst) {
      return oldInst;
    }
    ...
    // 创建 Tooltip HTML
    _this.$tooltip = $(
      '<div class="lavandula-tooltip" id="' + $.guid() + '">' +
  ...
  var transitionEnd = function (inst) {
    if (inst.$tooltip.hasClass('lavandula-tooltip-open')) {
      inst.state = 'opened';
  ...
  Tooltip.prototype._doOpen = function () {
    ...
    _this.$tooltip
      .addClass('lavandula-tooltip-open')
  ...
  Tooltip.prototype.open = function (opts) {
    ...
    // 合并 data 属性参数
    $.extend(_this.options, parseOptions(_this.$target.attr('lavandula-tooltip')));
    if (opts) {
  ...
  Tooltip.prototype.close = function () {
    ...
    _this.$tooltip
      .removeClass('lavandula-tooltip-open')
      .transitionEnd(function () {
        transitionEnd(_this);
      });
  };
  ...
  /*Tooltip.prototype.destroy = function () {
    var _this = this;
    clearTimeout(_this.timeoutId);
    $.data(_this.target, 'lavandula.tooltip', null);
