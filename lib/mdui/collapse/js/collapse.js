...
var CollapsePrivate = (function () {
  ...
  function Collapse(selector, opts, namespace) {
    ...
    // 类名
    var classpPefix = 'lavandula-' + _this.ns + '-item';
    ...
    var oldInst = _this.$collapse.data('lavandula.' + _this.ns);
    if (oldInst) {
      return oldInst;
    }
    ...
    // 绑定关闭按钮
    _this.$collapse.on('click', '[lavandula-' + _this.ns + '-item-close]', function () {
