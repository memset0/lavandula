...
(function () {
  ...
  var Ripple = {
    ...
    show: function (e, $ripple) {
      ...
      // 涟漪的 DOM 结构
      $('<div class="lavandula-ripple-wave" style="' +
        'width: ' + diameter + 'px; ' +
        'height: ' + diameter + 'px; ' +
    ...
    hide: function (e, element) {
      ...
      $ripple.children('.lavandula-ripple-wave').each(function () {
        removeRipple($(this));
      });
  ...
  function removeRipple($wave) {
    ...
    $wave
      .addClass('lavandula-ripple-wave-fill')
      .transform(translate.replace('scale(1)', 'scale(1.01)'))
      .transitionEnd(function () {
        clearTimeout(removeTimeout);

        $wave
          .addClass('lavandula-ripple-wave-out')
          .transform(translate.replace('scale(1)', 'scale(1.01)'));
  ...
  function showRipple(e) {
    ...
    // 获取含 .lavandula-ripple 类的元素
    if ($target.hasClass('lavandula-ripple')) {
      $ripple = $target;
    } else {
      $ripple = $target.parents('.lavandula-ripple').eq(0);
    }
