...
lavandula.Headroom = (function () {
  ...
  var DEFAULT = {
    ...
    initialClass: 'lavandula-headroom',                // 初始化时添加的类
    pinnedClass: 'lavandula-headroom-pinned-top',      // 元素固定时添加的类
    unpinnedClass: 'lavandula-headroom-unpinned-top',  // 元素隐藏时添加的类
  };
  ...
  function Headroom(selector, opts) {
    ...
    var oldInst = _this.$headroom.data('lavandula.headroom');
    if (oldInst) {
      return oldInst;
    }
